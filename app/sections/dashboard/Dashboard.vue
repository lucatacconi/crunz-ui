<template>
    <div>
        <v-container>
            <v-row v-if="env_check.ALL_CHECK">
                <v-col md="6" xs="12" class="mt-0 ml-0 pl-0 pt-0">
                    <v-card>
                        <v-card-title>Daily task's prospect</v-card-title>
                        <v-card-text>
                            <canvas id="graph-area-1"></canvas>
                        </v-card-text>
                    </v-card>
                </v-col>
                <v-col md="6" xs="12" class="mt-0 mr-0 pr-0 pt-0">
                    <v-card>
                        <v-card-title>Prova1</v-card-title>
                        <v-card-text>
                            <canvas id="graph-area-2"></canvas>
                        </v-card-text>
                    </v-card>
                </v-col>
            </v-row>
